      ...
      <Container className="d-flex justify-content-center mt-5">
        ...
        >
          ...
          <Form.Group className="mb-3">
            ...
            />
            {emailSuggestion && (
              <small className="text-danger">{emailSuggestion}</small>
            )}
          </Form.Group>
          ...
          <Form.Group className="mb-3">
                ...
                onChange={(e) => {
                  ...
                  setPasswordError(
                    validatePassword(e.target.value)
                      ? ""
                      : "Weak password. Must contain uppercase, number & special character."
                  );
                }}
                value={password}
            ...
            {emailWarning && (
              <small className="text-danger">{emailWarning}</small>
            )}
          </Form.Group>
